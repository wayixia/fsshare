...
ShareRTCControl 继承ShareRTCBase，连接发起方，给定peerid相关信息，通过web api获取到iceserver: 用于创建RTCPeerConnection（对webrtc peerconnection封装）， signalserver url: 用于登录信令服务器, 创建SignalConnection

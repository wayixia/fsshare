...
#include "sharertc/peerconnection/client/conductor.h"
#include "sharertc/peerconnection/client/flag_defs.h"
#include "sharertc/peerconnection/client/main_wnd.h"
#include "sharertc/peerconnection/client/peer_connection_client.h"
#include "sharertc/peerconnection/client/websocket_client.h"
...
int main( int argc, char* argv[]) {
   WebSocketClient client;
    ...
    client.setOnConnect([]()
    {
        std::cout << "[系统] WebSocket 连接成功！" << std::endl;
    });

    client.setOnDisconnect([]()
    {
        std::cout << "[系统] WebSocket 连接断开" << std::endl;
    });

    client.setOnRecvMessage([](const std::string& msg)
    {
    ...
    while (true)
    {
        ...
        {
            std::string text = "测试消息 #" + std::to_string(count++);

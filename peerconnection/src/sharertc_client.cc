...
// void ShareRTCClient::DeletePeerConnection() {
//   peer_connection_factory_ = nullptr;
//   peer_id_ = -1;
//   loopback_ = false;
// }

// void ShareRTCClient::EnsureStreamingUI() {
//   RTC_DCHECK(peer_connection_);
...
// void ShareRTCClient::OnAddTrack(
...
// void ShareRTCClient::OnRemoveTrack(
//     webrtc::scoped_refptr<webrtc::RtpReceiverInterface> receiver) {
//   RTC_LOG(LS_INFO) << __FUNCTION__ << " " << receiver->id();
//   //main_wnd_->QueueUIThreadCallback(TRACK_REMOVED, receiver->track().release());
// }

// void ShareRTCClient::OnIceCandidate(const webrtc::IceCandidate* candidate) {
...
// void ShareRTCClient::OnSignedIn() {
//   RTC_LOG(LS_INFO) << __FUNCTION__;
//   // main_wnd_->SwitchToPeerList(client_->peers());
// }

// void ShareRTCClient::OnDisconnected() {
//   RTC_LOG(LS_INFO) << __FUNCTION__;
...
// void ShareRTCClient::OnPeerConnected(int id, const std::string& name) {
//   RTC_LOG(LS_INFO) << __FUNCTION__;
...
// void ShareRTCClient::OnPeerDisconnected(int id) {
//   RTC_LOG(LS_INFO) << __FUNCTION__;
//   // if (id == peer_id_) {
...
// void ShareRTCClient::OnMessageFromPeer(int peer_id, const std::string& message) {
...
// void ShareRTCClient::OnMessageSent(int err) {
//   // Process the next pending message if any.
//   // main_wnd_->QueueUIThreadCallback(SEND_MESSAGE_TO_PEER, nullptr);
// }

// void ShareRTCClient::OnServerConnectionFailure() {
...
// void ShareRTCClient::ConnectToPeer(int peer_id) {
//   RTC_DCHECK(peer_id_ == -1);
...
// void ShareRTCClient::UIThreadCallback(int msg_id, void* data) {
//   switch (msg_id) {
...
// void ShareRTCClient::OnSuccess(webrtc::SessionDescriptionInterface* desc) {
...
// void ShareRTCClient::OnFailure(webrtc::RTCError error) {
